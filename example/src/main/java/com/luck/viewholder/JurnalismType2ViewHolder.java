 ...
 * FootRecyclerView
 */
public class JurnalismType2ViewHolder extends BaseViewHolder{

    private TextView viewholder_jurnalism_text1,viewholder_jurnalism_text2,viewholder_jurnalism_text3;

    public JurnalismType2ViewHolder(ViewGroup parent) {
        super(parent, R.layout.viewholder_jurnalismtype2);
